...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/arsenal/new',      component: () => import('@/views/arsenal/BallEditView.vue'),     meta: { requiresAuth: true, hideNav: true } },
    { path: '/arsenal/:id',      component: () => import('@/views/arsenal/BallDetailView.vue'),   meta: { requiresAuth: true, hideNav: true } },
    { path: '/arsenal/:id/edit', component: () => import('@/views/arsenal/BallEditView.vue'),     meta: { requiresAuth: true, hideNav: true } },
